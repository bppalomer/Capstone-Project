        ...
        <div className="container text-center">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <div className="navbar-center">
              <ul className="navbar-nav">
                <li className="nav-item">
                  <Link
                    to="/"
                    className={`nav-link ${find.pathname === "/" ? `fw-bold active` : ``
                      }`}
                  >
                    HOME
                  </Link>
                ...
                <li className="nav-item">
                  <Link
                    to="/About"
                    className={`nav-link ${find.pathname === "/About" ? `fw-bold active` : ``
                      }`}
                  >
                    ABOUT
                  </Link>
                ...
                <li className="nav-item dropdown">
                  <Link
                    to="/Apply"
                    className={`nav-link ${find.pathname === "/Apply" ? `fw-bold active` : ``
                      }`}
                  >
                    APPLY
                  </Link>
                ...
                <li className="nav-item">
                  <Link
                    to="/ContactUs"
                    className={`nav-link ${find.pathname === "/ContactUs" ? `fw-bold active` : ``
                      }`}
                  >
                    CONTACT US
                  </Link>
            ...
            <div className="navbar-right justify-content-center d-flex">
              ...
              <Link
                to="/Login"
                className={`nav-link ${find.pathname === "/Login" ? `fw-bold active` : ``
                  }`}
              >
