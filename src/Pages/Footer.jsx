    ...
    return (
        ...
        <div className="row">
            <div className="col-md-4">
                ...
                <p className="mt-2 ms-3">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Facere dolorum placeat
            ...
            <div className="col-md-3">
                <div>
                    ...
                    <input type="text" placeholder="Your Email Address" className="mt-3"></input>
                    <button className="btn btn-primary fw-bold">Subscribe Now</button>
                    <p className="mt-3"><small>Get the latest update annd offer for business service yearly</small></p>
                </div>
            </div>
        </div>
